...
Entity::Entity(glm::vec3 pos)
    : m_forward(0,0,-1), m_right(1,0,0), m_up(0,1,0), m_position(pos), m_prevPos(pos),
      mcr_position(m_position), mcr_prevPos(m_prevPos)
{}

Entity::Entity(const Entity &e)
    : m_forward(e.m_forward), m_right(e.m_right), m_up(e.m_up), m_position(e.m_position), m_prevPos(e.m_prevPos),
      mcr_position(m_position), mcr_prevPos(m_prevPos)
{}
