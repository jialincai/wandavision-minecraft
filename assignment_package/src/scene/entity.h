...
struct InputBundle {
    bool wPressed, sPressed, dPressed, aPressed, ePressed, qPressed, fPressed;
    bool spacePressed;
    float mouseX, mouseY;
    ...
    InputBundle()
        : wPressed(false), sPressed(false), dPressed(false),
          aPressed(false), ePressed(false), qPressed(false),
          fPressed(false), spacePressed(false), mouseX(0.f), mouseY(0.f),
          flightMode(true)
    {}
};
