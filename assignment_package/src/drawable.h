...
protected:
    ...
    GLuint m_bufInterleavedVBO; //A Vertex Buffer Object that will store each of the aove attribute in an interleaved format
    GLuint m_bufUV;
    ...
    bool m_hasVBOData;
    bool m_creatingVBOData;
public:
    // A readonly reference to m_hasVBOData for external use
    const bool& mcr_hasVBOData;
    const bool& mcr_creatingVBOData;
...
public:
    ...
    // Setter functions for various GL data
    void hasVBOData();
    void creatingVBOData();
